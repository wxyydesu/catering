        ...
        <div class="row g-4">
            <div class="col-12">
                <div class="bg-light rounded h-100 p-4">
                    <div class="row">
                        <div class="col-auto me-auto mb-5 h3 text-black-50">Payment Method::.add</div>
                    </div>
                    <for action="{{route('tambah')}}" method="POST" id="frmPaymentMethod" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3">
                            ...
                            <input class="form-control" name="metode_pembayaran" id="payment_method" maxlength="30"
                                ...
                                value="{{ $payment_methode }}" readonly>
                        ...
                        <input class="form-control invisible" name="id_jenis_pembayaran" id="id_jenis_pembayaran" value="{{$id}}"
                            type="text" aria-label="default input example">
                        <div class="text-end">

...
<body class="animsition">
	...
	<header class="header-v3">
		...
		<div class="container-menu-desktop trans-03">
			<div class="wrap-menu-desktop">
				<nav class="limiter-menu-desktop p-l-45">
					...
					<!-- Logo desktop -->		
					<a href="/" class="logo">
						<img src="{{asset('fe/images/icons/SIJA_Catering_logo.png')}}" alt="IMG-LOGO">
					</a>

					<!-- Menu desktop -->
					<div class="menu-desktop">
						<ul class="main-menu">
							<li @if ($title == 'Home') class="active-menu" @endif>
								<a href="/">Home</a>
								<!-- <ul class="sub-menu">
		...
		<div class="wrap-header-mobile">
			...
			<div class="logo-mobile">
				<a href="/"><img src="{{asset('fe/images/icons/SIJA_Catering_logo.png')}}" alt="IMG-LOGO"></a>
			</div>
    ...
    @endif
    @if ($title === 'Home' or $title === 'Product')
        @yield('product')
    @endif
...
<!--===============================================================================================-->
	...
	<script src="{{asset('fe/js/map-custom.js')}}"></script>	

                    ...
                    <div class="col">
                        <div class="bg-light rounded h-100 p-4">
                            <div class="container mb-5">
                                <div class="col-md-4">
                                    <h3 class="text-secondary">Food Package::.Create</h3>
                                </div>
                            </div>
                            <form action="{{route('paket.store')}}" method="POST" name="frmPaket" id="frmPaket" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="package_name" name="nama_paket" placeholder="example: Regular Wedding Package" maxlength="50" value="@isset($namaPaket) {{$namaPaket}} @endisset">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="category" name="kategori">
                                        ...
                                        <option value="Selamatan" @if(@isset($kategori) and $kategori == 'Selamatan') selected @endif>Salvation</option>
                                        <option value="Ulang Tahun" @if(@isset($kategori) and $kategori == 'Ulang Tahun') selected @endif>Birthday Party</option>
                                        <option value="Studi Tour" @if(@isset($kategori) and $kategori == 'Studi Tour') selected @endif>Studi Tour</option>
                                ...
                                <div class="mb-3">
                                    ...
                                    value= "@if(@isset($jumlahPax)) {{$jumlahPax}}@else{{'0'}} @endif">
                                </div>
                                <div class="mb-3">
                                    ...
                                    value= "@if(@isset($hargaPaket)) {{$hargaPaket}}@else{{'0'}} @endif">
                                </div>
                                <div class="mb-3">
                                    <label for="description" class="form-label">Description</label>
                                    <textarea class="form-control" name="deskripsi" placeholder="Leave a description here" id="description" style="height: 150px;" @if(@isset($deskripsi)) {{$deskripsi}} @endif></textarea>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3 mt-5 text-end">
                                    <div class="btn-group" role="group">
                                        ...
                                        <button type="button" class="btn btn-primary" id="btnSimpan">
                                            <i class="fas fa-download me-2"></i>Save a New Package</button>
                                    </div> 
                                </div>
                            </form>
                        </div>
